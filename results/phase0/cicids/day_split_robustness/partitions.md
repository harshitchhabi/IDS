...
Strategy `day_split`, config hash `ec12e0ec6b3ee5c5`. Reviewable without re-running; regenerate with `make phase0-explore`.
...
| prod_benign   | 167208 |   167208 |        0 |        0      | wednesday      | BENIGN                                                                                   |
| honeypot_pool | 141962 |   141604 |      358 |        0.0025 | thursday       | BENIGN,Infiltration,Web Attack - Brute Force,Web Attack - Sql Injection,Web Attack - XSS |
| trusted_eval  | 200801 |   140410 |    60391 |        0.3008 | friday         | BENIGN,Bot,DDoS,PortScan                                                                 |

## Row counts per partition / day / class

|                               |   attack |   benign |
|:------------------------------|---------:|---------:|
| ('honeypot_pool', 'thursday') |      358 |   141604 |
| ('prod_benign', 'wednesday')  |        0 |   167208 |
| ('seed_train', 'monday')      |        0 |   243493 |
| ('seed_train', 'tuesday')     |     3001 |   182368 |
| ('trusted_eval', 'friday')    |    60391 |   140410 |
...
- **attack** (n=40000): p0=0.000, p1=0.437, p5=0.645, p25=0.841, p50=0.882, p90=1.206; frac below grid = 0.0002
- **benign** (n=40000): p0=0.000, p1=0.002, p5=0.005, p25=0.011, p50=0.022, p90=0.116; frac below grid = 0.4672

### Per trusted_eval attack family (NN distance, sampled)

| family | arm | n | min RMS | median RMS |
|---|---|---|---|---|
| Bot | novel | 399 | 0.227 | 0.491 |
| DDoS | novel | 38861 | 0.072 | 0.884 |
...
|:---------|:------|:-------------|---------------:|------------------:|-----------------:|:-------------|
| Bot      | novel | strategy     |              0 |                 0 |              583 | True         |
| DDoS     | novel | strategy     |              0 |                 0 |            58697 | True         |
| PortScan | novel | strategy     |              0 |                 0 |             1111 | True         |
