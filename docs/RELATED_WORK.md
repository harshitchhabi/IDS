...
| Intelligent Threat Detection — AI-Driven Analysis of Honeypot Data to Counter Cyber Threats (`lanka2024intelligent`) | Phani Lanka, Khushi Gupta, Cihan Varol | Electronics 13(13), article 2465 | 2024 | api.crossref.org/works/10.3390/electronics13132465 (authoritative DOI metadata; corrects an earlier pass's wrong given names, "Poojitha Lanka, Kishor Datta Gupta") |
...
| HoneyGPT: Breaking the Trilemma in Terminal Honeypots with Large Language Model (`wang2024honeygpt`) | Ziyang Wang, Jianzhou You, Haining Wang, Tianwei Yuan, Shichao Lv, Yang Wang, Limin Sun | arXiv:2406.01882 (journal version: Computer Networks, 2026) | 2024 | export.arxiv.org/api/query?id_list=2406.01882 (corrects an earlier pass that truncated to the first 3 of 7 authors) |
